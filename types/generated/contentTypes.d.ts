...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    author: Attribute.Component<'shared.author'> & Attribute.Required;
    seo: Attribute.Component<'shared.seo'>;
    twitterSeo: Attribute.DynamicZone<
      [
        'shared.twitter-app',
    ...
    >;
    twitter_message: Attribute.Text;
...
export interface ApiBlogTagBlogTag extends Schema.CollectionType {
  ...
  attributes: {
    tagName: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiGlossaryGlossary extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    glossary_tag: Attribute.Relation<
      'api::glossary.glossary',
      'manyToOne',
      'api::glossary-tag.glossary-tag'
    >;
...
export interface ApiGlossaryTagGlossaryTag extends Schema.CollectionType {
...
export interface ApiGuideGuide extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media & Attribute.Required;
    downloadFile: Attribute.Media & Attribute.Required;
    toc: Attribute.Component<'shared.guide-toc', true> & Attribute.Required;
    seo: Attribute.Component<'shared.seo'>;
    twitter_message: Attribute.Text;
    twitterSeo: Attribute.DynamicZone<
      [
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::glossary-tag.glossary-tag': ApiGlossaryTagGlossaryTag;
